                ...
                <WrapperContainer>
                    <div className={styles.contact_row_wrapp}>
                        <Row className={styles.contact_row}>
                            <Col className={styles.contact_col} lg={6} md={12} sx={12} sm={12}>
                                ...
                                <div className={styles.contact_img_wrapp}>
                                    <img style={{ aspectRatio: 1 / 1, width: "100%" }} src={ContactImg} alt="" />
                                </div>
                            </Col>
                            <Col className={styles.contact_col} lg={6} md={12} sx={12} sm={12}>
                                ...
                                <div className={styles.contact_second_box}>
                                    <h4>{t("Contact.3")}</h4>
                                    <a className={styles.green_link} href="tel:+7 (342) 502-16-91">
                                        +7 (342) 502-16-91
                                    </a>
                                    <a className={styles.second_mail} href="mailto:purchase@grdok.ru">
                                        purchase@grdok.ru
                                    </a>
                                </div>
                                <div className={styles.contact_third_box}>
                                    <h4>{t("Contact.4")}</h4>
                                    <a className={styles.green_link} href="tel:+7 (495) 414-15-73">
                                        +7 (495) 414-15-73
                                    </a>
                                    <a className={styles.second_mail} href="mailto:sale@grdok.ru">
                                        sale@grdok.ru
                                    </a>
                                    <a className={styles.second_mail} href="t.me/@gremdok_bot">
                                        @gremdok_bot
                                    </a>
